...
generalTopTab = "Ogólny",
	myInfo     = "Moje informacje",
	plyLookup  = "Wyszukiwanie gracza",
	scoreboard = "Tablica wyników",

settingsTopTab = "Ustawienia",
	hud           = "HUD",
	panel         = "Panel",
	miscellaneous = "Inne",
...
xp         = "XP",
xpBar      = "XP Tabela",
xpNotify   = "XP Powiadomienia",
xpSystem   = "XP System",
positionSh = "Pos", // Short for position

xpBarStyle    = "Twój styl paska XP",
xpLeftToLevel = "XP pozostały do poziomu #", // The # is where the level number will be
xpBarStylePly = "Styl paska XP gracza",
...
listRemoveLine = "Usuń linię",
listAddLine    = "Dodaj linię",
...
loadingData          = "Żądanie danych...",
totalDaysVisited     = "Łączna liczba odwiedzonych dni",
consecutiveDaysCS    = "Kolejne dni bieżąca passa",
maxConsecutiveDaysCS = "Największa passa kolejnych dni",
rgbBarColor          = "RGB Kolor paska",
choosePaint          = "Wybierz, co malować!",
choosePlayerToLookUp = "Wybierz gracza do wyszukania",
fontOrText           = "Font/Text",
posXPBar             = "Pozycja paska XP",
xAxis                = "X Axis",
yAxis                = "Y Axis",
defaultServerPos     = "Domyślna pozycja serwera",
setDefaultServerPos  = "Ustaw bieżącą pozycję jako domyślną pozycję serwera (tylko administrator)",
toggleBarInfo        = "Przełącz informacje na pasku",
showXPBar            = "Pokaż pasek PD",
showLevelRightSide   = "Pokaż poziom po prawej stronie",
showLevelLeftSide    = "Pokaż poziom po lewej stronie",
showLevelTopSide     = "Pokaż poziom na górze",
showXPProgressText   = "Pokaż tekst postępu XP",
showHUDWhenDead      = "Pokaż Hud XP po śmierci",
showXPPercentage     = "Pokaż procent XP na pasku",
showNotificationPop  = "Pokaż powiadomienia jako wyskakujące okienka",
showChatNotification = "Pokaż powiadomienia czatu",
showXPBarAnimation   = "Pokaż animację paska XP podczas wygrywania/tracenia XP",
...
gmSandboxLabel1 = "Zabij gracza",
gmSandboxLabel2 = "XP zdobyte za zabicie gracza",
