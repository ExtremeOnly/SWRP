...
SWEP.Primary.Damage = 999999 -- How much it will hurt every time a bullet hits its target.
...
SWEP.Primary.ClipSize = 999 -- How much ammo can you hold in the clip at one time.
SWEP.Primary.Delay = 0.08 -- A delay between shots. Effects fire speed.
SWEP.Primary.DefaultClip = 999 -- How much ammo you spawn with.
