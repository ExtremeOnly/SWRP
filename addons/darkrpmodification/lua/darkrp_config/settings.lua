...
GM.Config.moneyModel = "models/crystal.mdl"
...
GM.Config.DefaultLaws = {
    "1. ExtremeOnly.ga/bug.",
    "2. ExtremeOnly.ga.",
    "Twórcy: Max White#8603 i Inferno Black#8735",
}
...
GM.Config.hudText = "Jestem zabójcą.\nKliknij E aby dać mi zlecenie!"
